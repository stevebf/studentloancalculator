...
This app lets you experiment and see how much a student likely to have to repay, and for how long, based on the follwoing factors:

* The annual tuition fee charged by the university. Usually it's £9000 per year. 
* What the student wants to borrow per year for living expenses.  It's capped according tochousehold income.
...
* Retail Price Index (RPI), an official givernment measure of inflation. It determines the rate at which the student is charged interest.
